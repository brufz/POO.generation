...
public class Projeto {
	...
	public static void main(String[] args) {
		...
		if (opcao1 == 1) {
			System.out.println(m1.getNome() + " dirige até o trabalho. No estacionamento acidentalmente encosta no carro de um "
			...
			System.out.println("2 - O funcionário sai do carro bravo, ofendendo" + m1.getNome() + ". Soltou palavras como \'tinha que ser mulher para não saber dirigir'."
					+ m1.getNome() + " sentiu medo por trabalhar no mesmo local que este homem, também se sentiu frustrada "
		...
		default:
			...
			System.out.println(m1.getNome() + " ficou preocupada em se atrasar para o trabalho, então, colocou rapidamente um"
